...
RSpec.describe StaffMember, type: :model do
  describe "#password=" do
    example "文字例を与えると、hashed_passwordは長さ60の文字霊になる" do
  ...
  describe "値の正規化" do
    example "email前後の空白を除去" do
      member = create(:staff_member, email: " text@example.com ")
      expect(member.email).to eq("text@example.com")
    end
  ...
  describe "バリデーション" do
    ...
    example "長音符を含むfamily_name_kana有効" do
